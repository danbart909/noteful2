...
class Note extends React.Component {
  ...
  handleClickDelete = e => {
    ...
    .then(() => {
      ...
      this.props.handleClickDelete(noteId)
    })
    .catch(error => {
    ...
    return (
      <li className="Note">
        ...
        <div>
          ...
          {/* <button onClick={(e) => {this.handleClickDelete(e)}}><Link id="deletenote" to={`/folders/${this.props.folderId}`}>Delete Note</Link></button> */}
